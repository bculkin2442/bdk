...
public class PropertyNameDialog extends Dialog implements ActionListener
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 3169205208039258607L;

	PropertyNameDialog(Frame frame, Object source, String message, Class match,
			boolean readable)
	{
		...
		try
		{
			allProperties = Introspector.getBeanInfo(source.getClass())
					.getPropertyDescriptors();
			if (allProperties == null)
			{
				new ErrorDialog(frame,
						"PropertyNameDialog : couldn't find PropertyDescriptors");
				return;
			}
		} catch (Exception ex)
		{
