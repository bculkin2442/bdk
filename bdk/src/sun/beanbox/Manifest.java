...
public class Manifest
{
    ...
    public MessageHeader getEntry(String name) {
        Enumeration<MessageHeader> enm = entries();
        while (enm.hasMoreElements())
        {
            MessageHeader mh = enm.nextElement();
     ...
     */
    public void stream(OutputStream os, Vector<String> extraFiles) throws IOException {
        ...
        if (globals.findValue("Manifest-Version") == null)
        {
            throw new IOException(
                    "Manifest file requires " + "Manifest-Version: 1.0 in 1st header");
        }
