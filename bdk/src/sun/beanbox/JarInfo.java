...
public class JarInfo
{
    ...
    private static Hashtable<String, String> beanToJar = new Hashtable<>();
     ...
     */
    public JarInfo(String jarName, SimpleClassLoader cl, String[] beanNames,
            boolean[] fromPrototype, MessageHeader[] manifestData)
    {
        ...
        beanInfos = new BeanInfo[beanNames.length];
        for (int i = 0; i < beanNames.length; i++)
        {
            ...
            {
                System.err.println(
                        "JarInfo: couldn't find BeanInfo for " + c + "; caught " + ex);
                continue;
            }
            beanInfos[i] = bi;
            debug("JarInfo:: @ " + i + "; beanName: " + beanNames[i] + "; fromPrototype: "
                    + fromPrototype[i]);
        }
    }
    ...
    public Object getInstance(String name) {
        ...
        } catch (Throwable th)
        {
            ...
            {
                System.err
                .println("    Note that file names in manifests must use forward "
     ...
     */
    void diagnoseInstantiationException(SimpleClassLoader cl, String beanName,
            Throwable realx) {
        ...
        {
            System.err.println(
                    "    We found a serialized template file \"" + serName + "\"");
            ...
            try
            {
                ...
                System.err.println(
                        "    An object could be read from the serialized template OK.");
                System.err.println(
                        "    But an exception was generated in Beans.instantiate:");
                System.err.println("        " + realx);
            } catch (java.io.ObjectStreamException ex)
            {
                System.err.println(
                        "    But caught an ObjectStreamException while reading the serialized object:");
                System.err.println("        " + ex);
                System.err.println(
                        "    This indicates there is a problem with the contents of the template file.");
            } catch (java.io.IOException ex)
            {
                System.err.println(
                        "    But caught an IOException while reading the serialized object:");
                System.err.println("        " + ex);
            ...
            {
                System.err.println(
                        "    But caught an unexpected exception while reading the serialized object:");
        ...
        {
            System.err.println("    But were unable to load the class \"" + beanName
                    + "\" because of");
            System.err.println("        " + ex);
        ...
        } catch (Throwable th)
        {
            ...
            if (th instanceof ClassFormatError
                    && th.getMessage().equals("Duplicate name"))
            {
                System.err.println(
                        "    This particular error is often caused by having a mismatch between the name of");
                System.err.println(
                        "    the .class file and the name of the contained class.");
                System.err.println(
                        "    In this case make sure that class file contains a class");
        ...
        {
            System.err.println(
                    "    But the class was not declared public, so we could not create a bean");
            return;
        }
        ...
        try
        {
            ...
            {
                System.err.println(
                        "    But the class did not have a zero-arg constructor.");
                System.err.println(
                        "    All beans must provide public zero-arg constructors.");
                return;
            }
            ...
            {
                System.err.println(
                        "    But the class's zero-arg constructor was not declared public");
                System.err.println(
                        "    All beans must provide public zero-arg constructors.");
                return;
            }
        } catch (NoSuchMethodException ex)
        {
            ...
            System.err
            .println("    All beans must provide public zero-arg constructors.");
            return;
        } catch (Throwable th)
        {
            System.err.println(
                    "    Unexpected exception in disgnoseInstantiationException");
            System.err.println("    " + th);
            th.printStackTrace();
            return;
        }
        ...
        } catch (Throwable th)
        {
            ...
            System.err.println("       " + th);
            System.err
            .println("    The stack backtrace at the time of this exception is");
            th.printStackTrace();
            return;
        }
