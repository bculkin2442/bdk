...
public class MakeAppDlg extends Dialog implements Runnable
{
     ...
     *
     */
    private static final long serialVersionUID = 1582053623747836634L;
    ...
    private static String defaultAppletName = beanNameFromJarName(defaultJarName);
    ...
    void chooseFile() {
        FileDialog fd = new FileDialog(frame, "Choose JAR File", FileDialog.SAVE);
    ...
    public void run() {
        ...
        setLayout(null);
        Label status
        = new Label("Generating and compiling " + getAppletName() + " Files");
        ...
        AppletGenerator.generate(frame, beanbox, this, getAppletDirectory(),
                getAppletName(), getJarName());
        dispose();
    }
...
class MakeAppletHelpDialog extends MessageDialog
{
     ...
     *
     */
    private static final long serialVersionUID = -9050923248761577606L;
