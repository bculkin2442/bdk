...
implements LayoutManager, Runnable, ActionListener, PropertyChangeListener
{

    /**
     *
     */
    private static final long serialVersionUID = -4287209832132202065L;
    ...
    public static void main(String argv[]) {
        ...
        } catch (Exception e)
        {
            ...
            System.err.println(
                    "You can download Java 2 SDK from http://java.sun.com/products/jdk/1.2");
