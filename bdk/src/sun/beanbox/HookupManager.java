...
public class HookupManager
{
    ...
    static void hookup(EventSetDescriptor esd, Method listenerMethod,
            Wrapper sourceWrapper, Wrapper targetWrapper, Method targetMethod) {
        ...
        try
        {
            ...
            String hookupName
            = generateHookup(esd, listenerMethod, source, target, targetMethod);
        ...
        {
            System.err.println(
                    "Hookup caught exception on target: " + ex.getTargetException());
    ...
    static String[] getHookupFiles() {
        ...
        Enumeration<String> e = javaFiles.elements();
    ...
    static String generateHookup(EventSetDescriptor esd, Method listenerMethod,
            Object source, Object target, Method targetMethod) {
        ...
        Hashtable<String, Hashtable<String, ?>> argt = new Hashtable<>();
        ...
        for (Method method : methods)
        {
            ...
            out.println(" {");
            if (listenerMethod.getName() == method.getName())
            {
    ...
    static
    {
        packageName = shortTmpDir.replace(java.io.File.separatorChar, '.') + "."
                + shortPackageName;
