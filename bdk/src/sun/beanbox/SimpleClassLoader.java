...
public class SimpleClassLoader extends ClassLoader
{
     ...
     */
    private static Hashtable<String, SimpleClassLoader> loaders = new Hashtable<>();
     ...
     */
    private Hashtable<String, InputStreamProducer> localOverrides = new Hashtable<>();
     ...
     */
    private Hashtable<String, Object> resourceHash = new Hashtable<>();
    private Hashtable<String, String> mimeHash = new Hashtable<>();
    ...
    private Hashtable<String, byte[]> rawClasses = new Hashtable<>();
    ...
    private Class<?> applyDefinition(String name, boolean resolve) {
        ...
        } else
        {
            ...
            if (!c.getName().equals(name))
            {
                ...
                System.err.println(
                        "    but instead contained class \"" + c.getName() + "\"");
    ...
    public synchronized boolean applyDefinitions(Vector<String> classList) {
        ...
        boolean back = true;
        for (Enumeration<String> k = classList.elements(); k.hasMoreElements();)
        {
            String classname = k.nextElement();
            ...
            if (c == null)
            {
                ...
                if (c == null)
                {
                    ...
                    {
                        System.err.println(
                                "NOTE: There are classes that cannot be defined in this JAR file");
                        System.err.println(
                                "    Some of these classes will cause the failure of defining or linking ");
                        System.err.println("    other classes that depend on them.");
                        if (keepLoading)
                        {
                            System.err.println(
                                    "NOTE: To simplify debugging JAR files, we will proceed loading classes");
                            System.err.println(
                                    "    although this may lead eventually to an UnknownError or the like");
                            System.err.println();
                        }
                    }
                    System.err.println(
                            "Class " + classname + " could not be defined from JAR file");
                    back = false;
                }
            }
        }
