...
public class Molecule extends java.awt.Panel
		implements Serializable, MouseListener, MouseMotionListener
{
	 ...
	 *
	 */
	private static final long serialVersionUID = -6258911067420715753L;
	...
	public synchronized void paint(Graphics g) {
		...
		{
			md.mat.unit();
			md.mat.translate(-(md.xmin + md.xmax) / 2, -(md.ymin + md.ymax) / 2,
					-(md.zmin + md.zmax) / 2);
			md.mat.mult(amat);
