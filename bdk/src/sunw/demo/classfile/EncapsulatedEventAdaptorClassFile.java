...
import sunw.demo.encapsulatedEvents.*;
...
public final class EncapsulatedEventAdaptorClassFile
{
    ...
    public EncapsulatedEventAdaptorClassFile(String className, OutputStream os)
            throws IOException, ClassNotFoundException
    {

        adaptorName = className;
        listenerName
        = EncapsulatedEventAdaptorGenerator.getBaseNameFromAdaptorName(className);
    ...
    private void generateClassSundries() {
        ...
        classFile.addFieldDesc(new FieldDesc("methods", "[Ljava/lang/reflect/Method;",
                (short) (FieldDesc.ACC_STATIC | FieldDesc.ACC_PRIVATE), classFile,
                (Attribute[]) null));
        ...
        getMethodsMethod = classFile.addMethodConstant("java/lang/Class", "getMethods",
                "()[Ljava/lang/reflect/Method;");
        ...
        forNameMethod = classFile.addMethodConstant("java/lang/Class", "forName",
        ...
        clazzField
        = classFile.addFieldConstant(adaptorName, "clazz", "Ljava/lang/Class;");
        ...
        classFile.addMethodDesc(new MethodDesc("getListenerClass", "()Ljava/lang/Class;",
    ...
    private void generateInitializer() {
        ...
        c.addOpShort(Code.OP_INVOKE_STATIC, forNameMethod.getConstantPoolIndex());
        ...
        c.addOpShort(Code.OP_INVOKE_VIRTUAL, getMethodsMethod.getConstantPoolIndex());
        ...
        classFile.addMethodDesc(new MethodDesc("<clinit>", "()V",
                (short) (MethodDesc.ACC_PRIVATE | MethodDesc.ACC_STATIC), classFile,
                ary));
    }
    ...
    private void generateConstructor() {
        ...
        mc = classFile.addMethodConstant(ClassFile.fullyQualifiedForm(superClassName),
                "<init>", "()V");
        ...
        classFile.addMethodDesc(
                new MethodDesc("<init>", "()V", MethodDesc.ACC_PUBLIC, classFile, ary));
    }
    ...
    private void generateListenerMethods() {
        for (int i = 0; i < listenerMethods.length; i++)
        {
            ...
            {
                System.err.println("Detected unexpected method signature: "
                        + listenerMethods[i] + " in interface: " + listenerName);
            } else
            {
                Class<?>[] lmParams = listenerMethods[i].getParameterTypes();
                Class<?>[] lmExceptions = listenerMethods[i].getExceptionTypes();

                if (lmParams != null && lmParams.length == 1
                        && java.util.EventObject.class.isAssignableFrom(lmParams[0]))
                {
                    generateSimpleListenerMethodStub(listenerMethods[i], lmParams[0],
                            lmExceptions, i);
                } else
                {
                    generateCrackedListenerMethodStub(listenerMethods[i], lmParams,
                            lmExceptions, i);
                }
            }
        }
    ...
    private void generateSimpleListenerMethodStub(Method listenerMethod,
        ...
        classFile.addMethodDesc(new MethodDesc(listenerMethod.getName(),
    ...
    private void generateCrackedListenerMethodStub(Method listenerMethod,
            ...
            int listenerMethodTableIndex) {
        Code c = new Code(classFile, (short) (listenerParams.length * 2 + 1), (short) 9);
        Attribute[] ary;
        String methodPDesc = "";
        ...
        for (int i = 0; i < listenerParams.length;
                i++, lvarIdx += (wasDoubleWord ? 2 : 1))
        {
        ...
        c.addOpShort(Code.OP_INVOKE_VIRTUAL, crackedFireMethod.getConstantPoolIndex()); // call
        // fire();
    ...
    private String processParam(Code c, Class<?> pClass, int pIdx) {
        ...
        while (pType.isArray())
        { // side - effect: construct array param desc
        ...
        { // builtin datatype
            if (pType.equals(java.lang.Long.TYPE))
            {
                ...
                if (!isArrayRef)
                {
                    ...
                    mc = classFile.addMethodConstant("java/lang/Long", "<init>", "(J)V");
            ...
            } else if (pType.equals(java.lang.Float.TYPE))
            {
                ...
                if (!isArrayRef)
                {
                    ...
                    mc = classFile.addMethodConstant("java/lang/Float", "<init>", "(F)V");
            ...
            } else if (pType.equals(java.lang.Double.TYPE))
            {
                ...
                if (!isArrayRef)
                {
                    ...
                    mc = classFile.addMethodConstant("java/lang/Double", "<init>",
                            "(D)V");
            ...
            { // integer, array or objref computational types ...
                ...
                if (pType.equals(java.lang.Boolean.TYPE))
                {
                    ...
                    if (!isArrayRef)
                    {
                        ...
                        mc = classFile.addMethodConstant("java/lang/Boolean", "<init>",
                                "(Z)V");
                ...
                } else if (pType.equals(java.lang.Character.TYPE))
                {
                    ...
                    if (!isArrayRef)
                    {
                        ...
                        mc = classFile.addMethodConstant("java/lang/Character", "<init>",
                                "(C)V");
                ...
                } else if (pType.equals(java.lang.Short.TYPE))
                {
                    ...
                    if (!isArrayRef)
                    {
                        ...
                        mc = classFile.addMethodConstant("java/lang/Short", "<init>",
                                "(S)V");
                ...
                } else if (pType.equals(java.lang.Integer.TYPE))
                {
                    ...
                    if (!isArrayRef)
                    {
                        ...
                        mc = classFile.addMethodConstant("java/lang/Integer", "<init>",
                                "(I)V");
                    }
                }
            }
        } else
        { // handle descriptors for non-primitives ...
        ...
        { // additional processing for primitives
            if (convOpCode != 0)
            { // narrow Int?
