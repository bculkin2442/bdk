...
public class QuoteMonitor extends Panel
{
     ...
     *
     */
    private static final long serialVersionUID = 6502735162561038939L;
    ...
    public void showBadServerDialog(String host) {
        ...
        String title = "QuoteMonitor Warning: \"" + host
                + "\" Couldn't Connect to Quote Server";
        ...
        for (String element : message)
            messagePanel.add(new Label("  " + element));
