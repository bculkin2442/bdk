...
public class PropertyPanel extends Panel
{
     ...
     *
     */
    private static final long serialVersionUID = 2486863704896208293L;
    GridBagLayout g = new GridBagLayout();
    GridBagConstraints c = new GridBagConstraints();
    Hashtable<String, TextField> propertyTable = new Hashtable<>();
