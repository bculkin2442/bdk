...
public class QuoteServerImpl extends UnicastRemoteObject implements QuoteServer
{
    /**
     *
     */
    private static final long serialVersionUID = -6146160500206367888L;
    ...
    void deliverQuotes() {
        ...
        Vector<QuoteListener> l;
        int n;

        synchronized (this)
        {
            l = (Vector<QuoteListener>) quoteListeners.clone();
            n = l.size();
            if (n == 0)
                return;
        }
        ...
        Hashtable<String, QuoteEvent> eventTable;
        ...
        for (int i = 0; i < l.size(); i++)
        {
            try
            {
                ...
                QuoteEvent e = eventTable.get(symbol.toUpperCase());
