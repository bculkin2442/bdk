...
public class OurButton extends java.awt.Button implements Serializable
{
	/**
	 *
	 */
	private static final long serialVersionUID = 6443121346111263596L;
	private boolean dbg;
	...
	public boolean handleEvent(Event evt) {
		if (evt.id == Event.ACTION_EVENT)
		{
			...
			{
				ButtonPushListener bl = (ButtonPushListener) l.elementAt(i);
				bl.push(e);
			}
