...
class Populate
{
	...
	static void createTables() {
		try
		{
			...
			s.execute(
					"CREATE TABLE PIPELINES ( " + "YEAR CHAR(4), " + "NAME VARCHAR(30), "
							+ "STAGES INTEGER," + "PRIMARY KEY (NAME)" + ")");

			s.execute("CREATE TABLE CHIPS ( " + "YEAR CHAR(4), " + "NAME VARCHAR(30), "
					+ "NICKNAME VARCHAR(30), " + "PIPELINE VARCHAR(30), "
					+ "LOW_MHZ VARCHAR(4)," + "HIGH_MHZ VARCHAR(4),"
					+ "VARIANT VARCHAR(5)," + "PRIMARY KEY (NAME), "
					+ "FOREIGN KEY (PIPELINE) REFERENCES PIPELINES" + ")");

			s.execute(
					"CREATE TABLE BOXES ( " + "QUARTER CHAR(4), " + "VENDOR VARCHAR(50), "
							+ "MODEL VARCHAR(100), " + "ARCHITECTURE VARCHAR(30), "
							+ "CHIP VARCHAR(30), " + "MHZ VARCHAR(4), "
							+ "SPEC89 VARCHAR(8), " + "SPECINT92 VARCHAR(8), "
							+ "SPECFP92 VARCHAR(8), " + "SPECINT95 VARCHAR(8), "
							+ "SPECFP95 VARCHAR(8), " + "PRICE VARCHAR(10), "
							+ "CONFIGURATION VARCHAR(100), " + "PRIMARY KEY (MODEL), "
	...
	static void box(String q, String model, String cpu, int mhz, int int92, int fp92,
			int dollars, String config) {
	...
	static void box(String q, String model, String cpu, String mhz, String spec89,
			String dollars) {
	...
	static void chip(int year, String name, String nickname, String pipeline, int lhz,
			int hhz, String version) {
		start();
		push("YEAR", "" + year);
		push("NAME", name);
	...
	static void addSparcs() {
		...
		box("Q295", "SPARCstation 4/110", "MicroSparc-II", 110, 65, 53, 4000,
				"15\"C 32M 1GD");
		box("Q295", "SPARCstation 5/110", "MicroSparc-II", 110, 79, 65, 10000,
				"17\"C 32M 1GD");
		...
		box("Q195", "SPARCstation 20/71", "SuperSparc-II", 75, 126, 121, 18000,
				"17\"C 32M 1GD");
		box("Q295", "SPARCstation 20/HS21", "HyperSparc", 125, 131, 153, 19000,
				"17\"C 32M 1GD");
		box("Q495", "SPARCstation 20/151", "HyperSparc", 150, 169, 208, 19000,
				"20\"C 32M 1GD");
		...
		box("Q294", "SPARCstation 5", "MicroSparc-II", 70, 57, 47, 4000,
				"15\"C 16M 500MD");
		box("Q494", "SPARCstation 20/HS11", "HyperSparc", 100, 104, 128, 19000,
				"17\"C 32M 1GD");
		box("Q195", "SPARCstation 4", "MicroSparc-II", 70, 60, 47, 4000,
				"15\"C 16M 535MD");
		box("Q294", "SPARCstation 5", "MicroSparc-II", 85, 64, 56, 10000,
				"17\"C 32M 1GD");
		box("Q492", "SPARCclassic", "MicroSparc", 50, 26, 21, 3000, "15\"C 16M 200MD");
		box("Q295", "SPARCstation 4/85", "MicroSparc-II", 85, 65, 53, 4000,
				"15\"C 16M 535MD");
