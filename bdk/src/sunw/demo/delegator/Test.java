...
class Bert
{
	...
	public short blek(Fred a, boolean b, char c, short d, Fred e, boolean f, char g,
			short h) {
		return h;
	}
}
...
public class Test
{
	...
	public static void main(String argv[]) {
		...
		try
		{
			...
			Class targs[] =
			{
					Fred.class, Bert.class
			};

			DelegatorClassFile guts
					= new DelegatorClassFile("sunw.demo.delegator.XXX", targs);
			guts.write(os);
