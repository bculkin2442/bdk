...
public class Juggler extends Applet implements Runnable, BeanContextProxy,
		BeanContextServicesListener, PropertyChangeListener, DesignMode
{
	/**
	 *
	 */
	private static final long serialVersionUID = 4200557533820365086L;
	...
	private BeanContextChildSupport bccs = new BeanContextChildSupport()
	{
		...
		/**
			 * 
			 */
		private static final long serialVersionUID = -7785366699783666617L;
		...
		protected void initializeBeanContextResources() {
			...
			try
			{
				...
				{
					mtService = (MethodTracer) bcs.getService(getBeanContextProxy(),
							Juggler.this, MethodTracer.class, null, Juggler.this);
				} else
				{
	...
	public void serviceAvailable(BeanContextServiceAvailableEvent bcsae) {
		if (bcsae.getServiceClass() == MethodTracer.class)
		{
			...
			try
			{
				mtService = (MethodTracer) bcsae.getSourceAsBeanContextServices()
						.getService(getBeanContextProxy(), this, MethodTracer.class, null,
								this);
			} catch (Exception ex)
			{
