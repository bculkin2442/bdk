...
public abstract class EncapsulatedEventAdaptor
{
    ...
    protected Vector<EncapsulatedEventListener> listeners = new Vector<>(0, 1);
    ...
    public static EncapsulatedEventAdaptor getEncapsulatedEventAdaptor(Class<?> lc, Object s)
        ...
        if (validateEventSource(sesd, lc) == -1)
        {
            throw new IllegalArgumentException(
                    "Object: " + s + " does not source: " + lc.getName());
        }
    ...
    public static Class<?> getEncapsulatedEventAdaptorClass(Class<?> lc)
            throws ClassNotFoundException {
    ...
    /**
     * @return the name of the java.util.EventListener subinterface this instance
     *         adapts.
     */
    ...
    public synchronized void setSource(Object s)
        ...
        {
            throw new IllegalArgumentException(
                    "Object: " + s + " does not source: " + getListenerClassName());
        }
    ...
    /**
     * @param el Adds the EncapsulatedEventListener to the listeners for this
     *           adaptor
     */
    ...
    /**
     * @param el Removes the EncapsulatedEventListener to the listeners for this
     *           adaptor
     */
    ...
    public Vector<EncapsulatedEventListener> getEncapsulatedListeners() {
        Vector<EncapsulatedEventListener> copy;

        synchronized (listeners)
        {
            copy = (Vector<EncapsulatedEventListener>) listeners.clone();
        }
    ...
    protected void fire(EventObject e, Method lm) throws Exception {
        Vector<EncapsulatedEventListener> copy = null;
    ...
    protected final void handleEncapsulatedEventException(EncapsulatedEventException ex,
            EncapsulatedEventListener eel, Method lm) throws Exception {
        ...
        for (Class<?> element : ext)
        {
            if (element.isAssignableFrom(ec))
        ...
        throw new RuntimeException(
                "Event Source [" + source + "] is not prepared to catch ["
                        + ex.getException() + "] from listener [" + eel);
    }
    ...
    protected void addAdaptorToSource() {
        ...
        {
            System.err.println("cannot add adaptor [" + this + "] to source [" + source
    ...
    protected void removeAdaptorFromSource() {
        ...
        {
            System.err.println("cannot remove adaptor [" + this + "] from source ["
                    + source + "] InvocationTargetException: " + ite.getMessage());
        } catch (IllegalAccessException iae)
        {
            System.err.println("cannot remove adaptor [" + this + "] from source ["
                    + source + "] IllegalAccessException: " + iae.getMessage());
        }
    }
}
